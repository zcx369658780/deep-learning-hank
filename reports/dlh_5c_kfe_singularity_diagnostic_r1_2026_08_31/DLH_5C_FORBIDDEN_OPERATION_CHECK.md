...
Diagnostic-only discipline: no-overwrite R1 output root `reports/dlh_5c_kfe_singularity_diagnostic_r1_2026_08_31`; deterministic repeats only; accepted KFE called to reproduce success and failure exactly.
