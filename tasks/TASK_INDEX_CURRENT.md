...
状态：`P1A_ACCEPTED__ISSUE_75_P1B_ACTIVE_OPERATIVE`。
...
- Reviewer final activation comment 紧随本次同步发布；Builder 必须以该 comment 指定的 exact operative baseline 与 branch 为准。
