...
路线：`DLH-WL-V1-20260918`。P0；科学 Issue NONE。
...
下一顺序：Owner 替换项目源 → DSH 按 SYNC_ONLY 协议同步并 STOP → Reviewer 核对 → 发布 P1。P1 是已有家庭依赖登记及离线 W/P/F 接口，不重新审计求解全部 HA；训练在后续明确 Issue 中事前授权。
