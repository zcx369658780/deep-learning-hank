...
DLH-5V-N, Issue #61 / DLH-5V-M and Issue #60 / DLH-5V-L are ACCEPTED /
CLOSED. The value-damping (#60), adaptive-resolvent (#61), local-geometry
(#62), continuous-FTB (#63), frozen-policy-Newton-geometry (#64) and
F0-final-validation-semantics (#65) gates are closed.

## Next active gate — Issue #66 / DLH-5V-R
...
accepted oracle / MATLAB-faithful source provenance, source-backed only.
Read-only diagnostic/provenance work; does NOT authorize replacing
`final=True`, changing the convergence criterion, or modifying the selected-Q
source. Local diagnostic only.
...
- frozen ex ante equivalence classifications on F0 rows with the same current
  ...
  `MIXED_OR_UNRESOLVED`; also record `||R_iter||_inf`,
...
Builder scientific branch beyond the Issue #66 dedicated branch may start
before that.
