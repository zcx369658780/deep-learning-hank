...
聊天 prompt 不扩大 Issue authority。若 Issue、activation、baseline、read-only blob identity 或 preprocessing prediction-path gate 冲突，fail closed。
